...
namespace RedDog.VirtualWorker.Controllers
{
    ...
    public class VirtualWorkerController : ControllerBase
    {
        ...
        public static readonly int MinSecondsToCompleteItem = int.Parse(Environment.GetEnvironmentVariable("MIN_SECONDS_TO_COMPLETE_ITEM") ?? "0");
        public static readonly int MaxSecondsToCompleteItem = int.Parse(Environment.GetEnvironmentVariable("MAX_SECONDS_TO_COMPLETE_ITEM") ?? "1");
